            ...
            <div id="sidebar" class="position-fixed top-0 vh-100 bg-white p-3 overflow-hidden z-1">
                ...
                <div class="accordion accordion-flush" id="accordionFlushExample">
                    ...
                    <div class="accordion-item mb-2 rounded-3 border-0">
                        ...
                        <button class="accordion-body btn bg-light fw-bold text-secondary p-2 mt-2" onclick="openPage('../notice/manage notice.php')">Manage Notice</button>
                        </div>
                    </div>
                    <!-- Sidebar Element -->
                    ...
                    <div class="accordion-item mb-2 rounded-3 border-0">
                        ...
                        <button class="accordion-body btn bg-light fw-bold text-secondary p-2 mt-2" onclick="openPage('../attendance/update attendance.php')">Update Attendance</button>
                        </div>
                    </div>
                    <!-- Sidebar Element -->
