...
if (!isset($_GET['class'])) {
    ...
    <body>
        ...
        <script>
            let openClass = ()=>{
                window.open(`update attendance.php?subjectId=<?php echo htmlentities($subId)?>&subjectName=<?php echo htmlentities($subName)?>&class=${document.getElementById('cls').value}`,"_self");
            }
        </script>
    </body>
                ...
                <div class="table-responsive">
                    ...
                    <input type="hidden" name="session" value="<?php echo htmlentities($session)?>">
                        <table id="Table" class="table table-hover caption-top">
                            <caption class="h3 fw-bold">Update Attendance (<?php echo htmlentities($subName)?>)</caption>
                            <thead>
                                <th>Id</th>
                                <th>Student Id</th>
                                <th>Student Name</th>
