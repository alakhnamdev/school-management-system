    ...
    <div class="p-3">
        <div class="p-3 rounded-4 border border-2">
            ...
            <div class="d-flex gap-3">
                <a href="attendance.php?view=subject" class="text-decoration-none bg-dark rounded-3">
                    <button class="btn text-light p-3">By Subject</button>
                </a>
                <a href="attendance.php?view=class"class="text-decoration-none bg-dark rounded-3">
