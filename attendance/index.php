...
<body>
    ...
    <div class="p-3">
        <div class="p-3 rounded-4 border border-2">
            <header>    
                <h1 class="h1 fw-bold">Attendance</h1>
                <hr class="hr">
            </header>
            <div class="d-flex gap-3">
                <a href="attendance.php?view=subject" class="text-decoration-none bg-light border border-3 border-dark rounded-3">
                    <button class="btn text-dark p-5"><div class="h3 fw-bold">By Subject</div></button>
                </a>
                <a href="attendance.php?view=class"class="text-decoration-none bg-light border border-3 border-dark rounded-3">
